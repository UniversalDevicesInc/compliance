...
@Component({
  selector: 'app-editorrange',
  templateUrl: './editorrange.component.html',
  styleUrls: ['./editorrange.component.scss']
})
export class EditorrangeComponent implements OnInit {
  ...
  typeValue: String = 'editorrange'
  current: Object = {}
  public displayedColumns: string[] = ['name','description','editor','uom','nls','edit','delete']
